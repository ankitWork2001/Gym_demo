    ...
    <div>
      <div className="flex flex-col items-center justify-center w-full bg-black mt-10">
        <div className="md:w-3/4 h-[80vh] flex flex-col items-center justify-center gap-10">
          <h1 className="text-2xl md:text-6xl text-white font-bold">CONTACT US</h1>
          <p className="text-white text-lg md:text-2xl font-serif">
            Please fill the following form if you are interested in partnering with us and contact us for any queries
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-around gap-10 mt-20">
        ...
        <div className="flex flex-col items-start justify-start w-screen md:w-[500px]">
          <h1 className="text-3xl mb-3 font-bold">Address of HO</h1>
          <p className="text-md text-gray-600">
            Besides LSBI, Badminton Court, near Nyati Enchante Society, behind F Residency, Digambar Nagar, Wadgaon Sheri, Pune, Maharashtra 411014
          </p>
        </div>
      </div>
